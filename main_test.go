...
func Test_checkEthAddress(t *testing.T) {
	tests := []struct {
		...
		{name: "upper case", address: "0x23a27adea399f2F2Fc69c49aB45acC00378e4EFA", want: true},
		{name: "lower case", address: "0x23a27adea399f2f2fc69c49ab45acc00378e4efa", want: true},
